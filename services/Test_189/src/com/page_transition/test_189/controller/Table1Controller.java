...
import com.page_transition.test_189.service.Table1Service;
...
import com.page_transition.test_189.*;
import com.page_transition.test_189.service.*;


/**
 * Controller object for domain model class Table1.
 * @see com.page_transition.test_189.Table1
 */

@RestController(value = "Test_189.Table1Controller")
@Api(value = "/Test_189/Table1", description = "Exposes APIs to work with Table1 resource.")
@RequestMapping("/Test_189/Table1")
public class Table1Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table1Controller.class);

	@Autowired
	@Qualifier("Test_189.Table1Service")
