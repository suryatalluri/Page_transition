...
@Service
public class Test_189QueryExecutorServiceImpl implements Test_189QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Test_189QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("Test_189WMQueryExecutor")
